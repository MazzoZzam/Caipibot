...
def gerenciar_pedido(mensagem):
    ...
    return ("Entendido vamos gerenciar os pedidos \n"
            ...
            "2️⃣ Processar ultimo pedido \n"
            "3️⃣ Processar pedidos por id \n"
            "4️⃣ Voltar ao menu \n")
...
def processar_pedido(mensagem):
    ...
    if op == "1" or "sim" in op:
        ...
        return "Pedido realizado com sucesso! Retornando ao menu... \n" + apresentar_menu("")
...
def pedidos_aprovados(mensagem):
    ...
    if not aprovados:
        return "Nenhum pedido aprovado, retornando ao menu..." + apresentar_menu("")
...
estado_conversa = {
    ...
    "processar_pedido": processar_pedido,
